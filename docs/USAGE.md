...
```text
Read AGENTS.md, PLANS.md, research/README.md, and .agents/skills/problem-framing/SKILL.md.
...
```text
Read AGENTS.md, `research/research_plan.md`, and the literature-related files in `research/`.
...
```text
Read AGENTS.md, `research/research_plan.md`, `research/open_questions.md`, and `.codex/agents/experiment_designer.toml`.
...
```text
Read AGENTS.md, `research/findings.md`, `research/claims_registry.md`, and `.agents/skills/claim-audit/SKILL.md`.
...
```text
Read AGENTS.md, `research/findings.md`, `research/reviews/repro_checklist.md`, and `.agents/skills/repro-check/SKILL.md`.
Spawn `repro_reviewer`.
Use $repro-check to review whether the current result is safe to share externally.
Update `research/reviews/repro_checklist.md` and `research/open_questions.md` with blockers and risk level.
```

## 6. Draft A Section After Evidence Is Ready

```text
Read AGENTS.md, `research/findings.md`, `research/claims_registry.md`, and `.agents/skills/paper-drafting/SKILL.md`.
Run $paper-drafting only on verified findings.
Draft a cautious methods or experiments section with citation placeholders and list any evidence gaps that still block a stronger conclusion.
```

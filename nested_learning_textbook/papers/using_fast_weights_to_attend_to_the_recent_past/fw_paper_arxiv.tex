...
%% \footnote{The idea of memories as stable states of a dynamic system dates back to at least 1922 \cite{} when I. A. Richards, influenced by German
 %% Gestalt psychologists, used an analogy in which memories were modelled as the stable poses of a multifaceted crystal.}. 
...
%% \footnote{Willshaw nets \cite{Willshaw} use binary synapses and can approach the theoretical bound of storing one useful bit per synape by using sparse %% vectors in which only $log N$ of the $N$ components are on.}. 
...
\begin{figure}[t]
\vspace{-0.2in}
\subfigure[]{\includegraphics[width = 0.15\linewidth, trim = 0cm -0.2cm 0cm 0cm]{figures/catch.pdf}}
\subfigure[]{\includegraphics[width = 0.38\linewidth]{figures/catch_16x16.pdf}} %\hspace{3ex}
\subfigure[]{\includegraphics[width = 0.38\linewidth]{figures/catch_24x24.pdf}} %\hspace{3ex}
    \vspace{-0.1in}

...
\begin{figure*}[ht]
\begin{center}
\subfloat[][Task setup]{\includegraphics[width=1.1\columnwidth]{icml_task1.png}} \qquad
\subfloat[][Network strategy]{\includegraphics[width=0.89\columnwidth]{icml_task2.png}}
...
\begin{figure*}[t]
\centering
\subfloat[][LSTM, five random classes/episode, one-hot vector labels]{\includegraphics[width=0.99\columnwidth]{randomVectors_LSTMfake_5class_pCorrect}} \qquad
\subfloat[][MANN, five random classes/episode, one-hot vector labels]{\includegraphics[width=0.99\columnwidth]{randomVectors_LSTM_5class_pCorrect}}
\newline
\subfloat[][LSTM, fifteen classes/episode, five-character string labels]{\includegraphics[width=0.99\columnwidth]{randomWords_LSTMfake_15class_pCorrect}}\qquad
\subfloat[][MANN, fifteen classes/episode, five-character string labels]{\includegraphics[width=0.99\columnwidth]{randomWords_LSTM_15class_pCorrect}}
...
\begin{figure}[ht]
\centering
\subfloat[][Five classes per episode]{\includegraphics[width=0.99\columnwidth]{randomVectors_persistentMemory_LSTM_5class_pCorrect}}
\qquad
\subfloat[][Ten classes per episode]{\includegraphics[width=0.99\columnwidth]{randomVectors_persistentMemory_LSTM_10class_pCorrect}}
...
\begin{figure}[ht]
\centering
\subfloat[][One additional class per 10,000 episodes]{\includegraphics[width=0.98\columnwidth]{randomWords_curriculum1_LSTM_pCorrect}}
...
\begin{figure}[h]
\centering
\subfloat[][MANN predictions along all x-inputs after 20 samples]{\includegraphics[width=0.98\columnwidth]{regression_fan16}}
\newline
\subfloat[][GP predictions along all x-inputs after 20 samples]{\includegraphics[width=0.98\columnwidth]{gp_fan}}
...
\begin{figure}[h]
\centering
\subfloat[][2D regression log-likelihoods within an episode]{\includegraphics[width=0.98\columnwidth]{regression2D}}
\newline
\subfloat[][3D regression log-likelihoods within an episode]{\includegraphics[width=0.98\columnwidth]{regression3D}}
...
\begin{figure}[h]
\centering
\subfloat[][]{\includegraphics[width=0.7\columnwidth]{ntm}}
...
\begin{figure}[h]
\centering
\subfloat[][String label encoded as five-hot vector]{\includegraphics[width=0.9\columnwidth]{label}}
\qquad
\subfloat[][Input Sequence]{\includegraphics[width=0.9\columnwidth]{sequence}}
